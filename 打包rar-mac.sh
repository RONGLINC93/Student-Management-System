#!/usr/bin/env bash
# ===========================================================================
#  Student Management System - macOS 版 RAR 打包 (Linux / macOS 调用)
#
#  真正的打包逻辑在 build.js（Node.js 跨平台脚本）。
#  这个 .sh 只是为了方便 Linux / macOS 用户单独打 macOS 版。
#
#  同时打多个平台请用 ./打包全部.sh。
#  Windows 版请用 ./打包rar-win.sh。
#  Linux 版请用 ./打包rar-linux.sh。
#
#  前置: Node.js 14+ 已安装; rar 命令可用 (macOS 推荐 brew install --cask rar)
# ===========================================================================
